...
} forEach [[1900,CHVD_foot,CHVD_maxView_foot,1901,CHVD_footObj,CHVD_maxObj],[1902,CHVD_car,CHVD_maxView_land,1903,CHVD_carObj,CHVD_maxObj],[1904,CHVD_air,CHVD_maxView_air,1905,CHVD_airObj,CHVD_maxObj]];
